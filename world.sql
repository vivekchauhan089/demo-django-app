...
CREATE DATABASE IF NOT EXISTS `world` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `world`;

-- Dumping structure for table world.auth_group
...
-- Dumping data for table world.auth_group: ~0 rows (approximately)
/*!40000 ALTER TABLE `auth_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `auth_group` ENABLE KEYS */;

-- Dumping structure for table world.auth_group_permissions
...
-- Dumping data for table world.auth_group_permissions: ~0 rows (approximately)
/*!40000 ALTER TABLE `auth_group_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `auth_group_permissions` ENABLE KEYS */;

-- Dumping structure for table world.auth_permission
...
-- Dumping data for table world.auth_permission: ~40 rows (approximately)
...
INSERT IGNORE INTO `auth_permission` (`id`, `name`, `content_type_id`, `codename`) VALUES
	...
	(21, 'Can add city', 6, 'add_city'),
	(22, 'Can change city', 6, 'change_city'),
	(23, 'Can delete city', 6, 'delete_city'),
	(24, 'Can view city', 6, 'view_city'),
	...
	(29, 'Can add django migrations', 8, 'add_djangomigrations'),
	(30, 'Can change django migrations', 8, 'change_djangomigrations'),
	(31, 'Can delete django migrations', 8, 'delete_djangomigrations'),
	(32, 'Can view django migrations', 8, 'view_djangomigrations'),
	(33, 'Can add countrylanguage', 9, 'add_countrylanguage'),
	(34, 'Can change countrylanguage', 9, 'change_countrylanguage'),
	(35, 'Can delete countrylanguage', 9, 'delete_countrylanguage'),
	(36, 'Can view countrylanguage', 9, 'view_countrylanguage'),
...
INSERT IGNORE INTO `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES
...
CREATE TABLE IF NOT EXISTS `countrylanguage` (
  ...
  UNIQUE KEY `CountryCode_Language` (`CountryCode`,`Language`),
  KEY `CountryCode` (`CountryCode`),
  CONSTRAINT `countryLanguage_ibfk_1` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`Code`)
) ENGINE=InnoDB AUTO_INCREMENT=985 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Dumping data for table world.countrylanguage: ~984 rows (approximately)
/*!40000 ALTER TABLE `countrylanguage` DISABLE KEYS */;
INSERT IGNORE INTO `countrylanguage` (`id`, `CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES
	(1, 'ABW', 'Dutch', 'T', 5.3),
	(2, 'ABW', 'English', 'F', 9.5),
	...
	(11, 'AGO', 'Chokwe', 'F', 4.2),
	(12, 'AGO', 'Kongo', 'F', 13.2),
	(13, 'AGO', 'Luchazi', 'F', 2.4),
	(14, 'AGO', 'Luimbe-nganguela', 'F', 5.4),
	(15, 'AGO', 'Luvale', 'F', 3.6),
	(16, 'AGO', 'Mbundu', 'F', 21.6),
	(17, 'AGO', 'Nyaneka-nkhumbi', 'F', 5.4),
	(18, 'AGO', 'Ovimbundu', 'F', 37.2),
	(19, 'AIA', 'English', 'T', 0.0),
	(20, 'ALB', 'Albaniana', 'T', 97.9),
	(21, 'ALB', 'Greek', 'F', 1.8),
	(22, 'ALB', 'Macedonian', 'F', 0.1),
	(23, 'AND', 'Catalan', 'T', 32.3),
	(24, 'AND', 'French', 'F', 6.2),
	(25, 'AND', 'Portuguese', 'F', 10.8),
	(26, 'AND', 'Spanish', 'F', 44.6),
	(27, 'ANT', 'Dutch', 'T', 0.0),
	(28, 'ANT', 'English', 'F', 7.8),
	(29, 'ANT', 'Papiamento', 'T', 86.2),
	(30, 'ARE', 'Arabic', 'T', 42.0),
	(31, 'ARE', 'Hindi', 'F', 0.0),
	(32, 'ARG', 'Indian Languages', 'F', 0.3),
	(33, 'ARG', 'Italian', 'F', 1.7),
	(34, 'ARG', 'Spanish', 'T', 96.8),
	(35, 'ARM', 'Armenian', 'T', 93.4),
	(36, 'ARM', 'Azerbaijani', 'F', 2.6),
	(37, 'ASM', 'English', 'T', 3.1),
	(38, 'ASM', 'Samoan', 'T', 90.6),
	(39, 'ASM', 'Tongan', 'F', 3.1),
	(40, 'ATG', 'Creole English', 'F', 95.7),
	(41, 'ATG', 'English', 'T', 0.0),
	(42, 'AUS', 'Arabic', 'F', 1.0),
	(43, 'AUS', 'Canton Chinese', 'F', 1.1),
	(44, 'AUS', 'English', 'T', 81.2),
	(45, 'AUS', 'German', 'F', 0.6),
	(46, 'AUS', 'Greek', 'F', 1.6),
	(47, 'AUS', 'Italian', 'F', 2.2),
	(48, 'AUS', 'Serbo-Croatian', 'F', 0.6),
	(49, 'AUS', 'Vietnamese', 'F', 0.8),
	(50, 'AUT', 'Czech', 'F', 0.2),
	(51, 'AUT', 'German', 'T', 92.0),
	(52, 'AUT', 'Hungarian', 'F', 0.4),
	(53, 'AUT', 'Polish', 'F', 0.2),
	(54, 'AUT', 'Romanian', 'F', 0.2),
	(55, 'AUT', 'Serbo-Croatian', 'F', 2.2),
	(56, 'AUT', 'Slovene', 'F', 0.4),
	(57, 'AUT', 'Turkish', 'F', 1.5),
	(58, 'AZE', 'Armenian', 'F', 2.0),
	(59, 'AZE', 'Azerbaijani', 'T', 89.0),
	(60, 'AZE', 'Lezgian', 'F', 2.3),
	(61, 'AZE', 'Russian', 'F', 3.0),
	(62, 'BDI', 'French', 'T', 0.0),
	(63, 'BDI', 'Kirundi', 'T', 98.1),
	(64, 'BDI', 'Swahili', 'F', 0.0),
	(65, 'BEL', 'Arabic', 'F', 1.6),
	(66, 'BEL', 'Dutch', 'T', 59.2),
	(67, 'BEL', 'French', 'T', 32.6),
	(68, 'BEL', 'German', 'T', 1.0),
	(69, 'BEL', 'Italian', 'F', 2.4),
	(70, 'BEL', 'Turkish', 'F', 0.9),
	(71, 'BEN', 'Adja', 'F', 11.1),
	(72, 'BEN', 'Aizo', 'F', 8.7),
	(73, 'BEN', 'Bariba', 'F', 8.7),
	(74, 'BEN', 'Fon', 'F', 39.8),
	(75, 'BEN', 'Ful', 'F', 5.6),
	(76, 'BEN', 'Joruba', 'F', 12.2),
	(77, 'BEN', 'Somba', 'F', 6.7),
	(78, 'BFA', 'Busansi', 'F', 3.5),
	(79, 'BFA', 'Dagara', 'F', 3.1),
	(80, 'BFA', 'Dyula', 'F', 2.6),
	(81, 'BFA', 'Ful', 'F', 9.7),
	(82, 'BFA', 'Gurma', 'F', 5.7),
	(83, 'BFA', 'Mossi', 'F', 50.2),
	(84, 'BGD', 'Bengali', 'T', 97.7),
	(85, 'BGD', 'Chakma', 'F', 0.4),
	(86, 'BGD', 'Garo', 'F', 0.1),
	(87, 'BGD', 'Khasi', 'F', 0.1),
	(88, 'BGD', 'Marma', 'F', 0.2),
	(89, 'BGD', 'Santhali', 'F', 0.1),
	(90, 'BGD', 'Tripuri', 'F', 0.1),
	(91, 'BGR', 'Bulgariana', 'T', 83.2),
	(92, 'BGR', 'Macedonian', 'F', 2.6),
	(93, 'BGR', 'Romani', 'F', 3.7),
	(94, 'BGR', 'Turkish', 'F', 9.4),
	(95, 'BHR', 'Arabic', 'T', 67.7),
	(96, 'BHR', 'English', 'F', 0.0),
	(97, 'BHS', 'Creole English', 'F', 89.7),
	(98, 'BHS', 'Creole French', 'F', 10.3),
	(99, 'BIH', 'Serbo-Croatian', 'T', 99.2),
	(100, 'BLR', 'Belorussian', 'T', 65.6),
	(101, 'BLR', 'Polish', 'F', 0.6),
	(102, 'BLR', 'Russian', 'T', 32.0),
	(103, 'BLR', 'Ukrainian', 'F', 1.3),
	(104, 'BLZ', 'English', 'T', 50.8),
	(105, 'BLZ', 'Garifuna', 'F', 6.8),
	(106, 'BLZ', 'Maya Languages', 'F', 9.6),
	(107, 'BLZ', 'Spanish', 'F', 31.6),
	(108, 'BMU', 'English', 'T', 100.0),
	(109, 'BOL', 'AimarÃ¡', 'T', 3.2),
	(110, 'BOL', 'GuaranÃ­', 'F', 0.1),
	(111, 'BOL', 'KetÅ¡ua', 'T', 8.1),
	(112, 'BOL', 'Spanish', 'T', 87.7),
	(113, 'BRA', 'German', 'F', 0.5),
	(114, 'BRA', 'Indian Languages', 'F', 0.2),
	(115, 'BRA', 'Italian', 'F', 0.4),
	(116, 'BRA', 'Japanese', 'F', 0.4),
	(117, 'BRA', 'Portuguese', 'T', 97.5),
	(118, 'BRB', 'Bajan', 'F', 95.1),
	(119, 'BRB', 'English', 'T', 0.0),
	(120, 'BRN', 'Chinese', 'F', 9.3),
	(121, 'BRN', 'English', 'F', 3.1),
	(122, 'BRN', 'Malay', 'T', 45.5),
	(123, 'BRN', 'Malay-English', 'F', 28.8),
	(124, 'BTN', 'Asami', 'F', 15.2),
	(125, 'BTN', 'Dzongkha', 'T', 50.0),
	(126, 'BTN', 'Nepali', 'F', 34.8),
	(127, 'BWA', 'Khoekhoe', 'F', 2.5),
	(128, 'BWA', 'Ndebele', 'F', 1.3),
	(129, 'BWA', 'San', 'F', 3.5),
	(130, 'BWA', 'Shona', 'F', 12.3),
	(131, 'BWA', 'Tswana', 'F', 75.5),
	(132, 'CAF', 'Banda', 'F', 23.5),
	(133, 'CAF', 'Gbaya', 'F', 23.8),
	(134, 'CAF', 'Mandjia', 'F', 14.8),
	(135, 'CAF', 'Mbum', 'F', 6.4),
	(136, 'CAF', 'Ngbaka', 'F', 7.5),
	(137, 'CAF', 'Sara', 'F', 6.4),
	(138, 'CAN', 'Chinese', 'F', 2.5),
	(139, 'CAN', 'Dutch', 'F', 0.5),
	(140, 'CAN', 'English', 'T', 60.4),
	(141, 'CAN', 'Eskimo Languages', 'F', 0.1),
	(142, 'CAN', 'French', 'T', 23.4),
	(143, 'CAN', 'German', 'F', 1.6),
	(144, 'CAN', 'Italian', 'F', 1.7),
	(145, 'CAN', 'Polish', 'F', 0.7),
	(146, 'CAN', 'Portuguese', 'F', 0.7),
	(147, 'CAN', 'Punjabi', 'F', 0.7),
	(148, 'CAN', 'Spanish', 'F', 0.7),
	(149, 'CAN', 'Ukrainian', 'F', 0.6),
	(150, 'CCK', 'English', 'T', 0.0),
	(151, 'CCK', 'Malay', 'F', 0.0),
	(152, 'CHE', 'French', 'T', 19.2),
	(153, 'CHE', 'German', 'T', 63.6),
	(154, 'CHE', 'Italian', 'T', 7.7),
	(155, 'CHE', 'Romansh', 'T', 0.6),
	(156, 'CHL', 'AimarÃ¡', 'F', 0.5),
	(157, 'CHL', 'Araucan', 'F', 9.6),
	(158, 'CHL', 'Rapa nui', 'F', 0.2),
	(159, 'CHL', 'Spanish', 'T', 89.7),
	(160, 'CHN', 'Chinese', 'T', 92.0),
	(161, 'CHN', 'Dong', 'F', 0.2),
	(162, 'CHN', 'Hui', 'F', 0.8),
	(163, 'CHN', 'MantÅ¡u', 'F', 0.9),
	(164, 'CHN', 'Miao', 'F', 0.7),
	(165, 'CHN', 'Mongolian', 'F', 0.4),
	(166, 'CHN', 'Puyi', 'F', 0.2),
	(167, 'CHN', 'Tibetan', 'F', 0.4),
	(168, 'CHN', 'Tujia', 'F', 0.5),
	(169, 'CHN', 'Uighur', 'F', 0.6),
	(170, 'CHN', 'Yi', 'F', 0.6),
	(171, 'CHN', 'Zhuang', 'F', 1.4),
	(172, 'CIV', 'Akan', 'F', 30.0),
	(173, 'CIV', 'Gur', 'F', 11.7),
	(174, 'CIV', 'Kru', 'F', 10.5),
	(175, 'CIV', 'Malinke', 'F', 11.4),
	(176, 'CIV', '[South]Mande', 'F', 7.7),
	(177, 'CMR', 'Bamileke-bamum', 'F', 18.6),
	(178, 'CMR', 'Duala', 'F', 10.9),
	(179, 'CMR', 'Fang', 'F', 19.7),
	(180, 'CMR', 'Ful', 'F', 9.6),
	(181, 'CMR', 'Maka', 'F', 4.9),
	(182, 'CMR', 'Mandara', 'F', 5.7),
	(183, 'CMR', 'Masana', 'F', 3.9),
	(184, 'CMR', 'Tikar', 'F', 7.4),
	(185, 'COD', 'Boa', 'F', 2.3),
	(186, 'COD', 'Chokwe', 'F', 1.8),
	(187, 'COD', 'Kongo', 'F', 16.0),
	(188, 'COD', 'Luba', 'F', 18.0),
	(189, 'COD', 'Mongo', 'F', 13.5),
	(190, 'COD', 'Ngala and Bangi', 'F', 5.8),
	(191, 'COD', 'Rundi', 'F', 3.8),
	(192, 'COD', 'Rwanda', 'F', 10.3),
	(193, 'COD', 'Teke', 'F', 2.7),
	(194, 'COD', 'Zande', 'F', 6.1),
	(195, 'COG', 'Kongo', 'F', 51.5),
	(196, 'COG', 'Mbete', 'F', 4.8),
	(197, 'COG', 'Mboshi', 'F', 11.4),
	(198, 'COG', 'Punu', 'F', 2.9),
	(199, 'COG', 'Sango', 'F', 2.6),
	(200, 'COG', 'Teke', 'F', 17.3),
	(201, 'COK', 'English', 'F', 0.0),
	(202, 'COK', 'Maori', 'T', 0.0),
	(203, 'COL', 'Arawakan', 'F', 0.1),
	(204, 'COL', 'Caribbean', 'F', 0.1),
	(205, 'COL', 'Chibcha', 'F', 0.4),
	(206, 'COL', 'Creole English', 'F', 0.1),
	(207, 'COL', 'Spanish', 'T', 99.0),
	(208, 'COM', 'Comorian', 'T', 75.0),
	(209, 'COM', 'Comorian-Arabic', 'F', 1.6),
	(210, 'COM', 'Comorian-French', 'F', 12.9),
	(211, 'COM', 'Comorian-madagassi', 'F', 5.5),
	(212, 'COM', 'Comorian-Swahili', 'F', 0.5),
	(213, 'CPV', 'Crioulo', 'F', 100.0),
	(214, 'CPV', 'Portuguese', 'T', 0.0),
	(215, 'CRI', 'Chibcha', 'F', 0.3),
	(216, 'CRI', 'Chinese', 'F', 0.2),
	(217, 'CRI', 'Creole English', 'F', 2.0),
	(218, 'CRI', 'Spanish', 'T', 97.5),
	(219, 'CUB', 'Spanish', 'T', 100.0),
	(220, 'CXR', 'Chinese', 'F', 0.0),
	(221, 'CXR', 'English', 'T', 0.0),
	(222, 'CYM', 'English', 'T', 0.0),
	(223, 'CYP', 'Greek', 'T', 74.1),
	(224, 'CYP', 'Turkish', 'T', 22.4),
	(225, 'CZE', 'Czech', 'T', 81.2),
	(226, 'CZE', 'German', 'F', 0.5),
	(227, 'CZE', 'Hungarian', 'F', 0.2),
	(228, 'CZE', 'Moravian', 'F', 12.9),
	(229, 'CZE', 'Polish', 'F', 0.6),
	(230, 'CZE', 'Romani', 'F', 0.3),
	(231, 'CZE', 'Silesiana', 'F', 0.4),
	(232, 'CZE', 'Slovak', 'F', 3.1),
	(233, 'DEU', 'German', 'T', 91.3),
	(234, 'DEU', 'Greek', 'F', 0.4),
	(235, 'DEU', 'Italian', 'F', 0.7),
	(236, 'DEU', 'Polish', 'F', 0.3),
	(237, 'DEU', 'Southern Slavic Languages', 'F', 1.4),
	(238, 'DEU', 'Turkish', 'F', 2.6),
	(239, 'DJI', 'Afar', 'F', 34.8),
	(240, 'DJI', 'Arabic', 'T', 10.6),
	(241, 'DJI', 'Somali', 'F', 43.9),
	(242, 'DMA', 'Creole English', 'F', 100.0),
	(243, 'DMA', 'Creole French', 'F', 0.0),
	(244, 'DNK', 'Arabic', 'F', 0.7),
	(245, 'DNK', 'Danish', 'T', 93.5),
	(246, 'DNK', 'English', 'F', 0.3),
	(247, 'DNK', 'German', 'F', 0.5),
	(248, 'DNK', 'Norwegian', 'F', 0.3),
	(249, 'DNK', 'Swedish', 'F', 0.3),
	(250, 'DNK', 'Turkish', 'F', 0.8),
	(251, 'DOM', 'Creole French', 'F', 2.0),
	(252, 'DOM', 'Spanish', 'T', 98.0),
	(253, 'DZA', 'Arabic', 'T', 86.0),
	(254, 'DZA', 'Berberi', 'F', 14.0),
	(255, 'ECU', 'KetÅ¡ua', 'F', 7.0),
	(256, 'ECU', 'Spanish', 'T', 93.0),
	(257, 'EGY', 'Arabic', 'T', 98.8),
	(258, 'EGY', 'Sinaberberi', 'F', 0.0),
	(259, 'ERI', 'Afar', 'F', 4.3),
	(260, 'ERI', 'Bilin', 'F', 3.0),
	(261, 'ERI', 'Hadareb', 'F', 3.8),
	(262, 'ERI', 'Saho', 'F', 3.0),
	(263, 'ERI', 'Tigre', 'F', 31.7),
	(264, 'ERI', 'Tigrinja', 'T', 49.1),
	(265, 'ESH', 'Arabic', 'T', 100.0),
	(266, 'ESP', 'Basque', 'F', 1.6),
	(267, 'ESP', 'Catalan', 'F', 16.9),
	(268, 'ESP', 'Galecian', 'F', 6.4),
	(269, 'ESP', 'Spanish', 'T', 74.4),
	(270, 'EST', 'Belorussian', 'F', 1.4),
	(271, 'EST', 'Estonian', 'T', 65.3),
	(272, 'EST', 'Finnish', 'F', 0.7),
	(273, 'EST', 'Russian', 'F', 27.8),
	(274, 'EST', 'Ukrainian', 'F', 2.8),
	(275, 'ETH', 'Amhara', 'F', 30.0),
	(276, 'ETH', 'Gurage', 'F', 4.7),
	(277, 'ETH', 'Oromo', 'F', 31.0),
	(278, 'ETH', 'Sidamo', 'F', 3.2),
	(279, 'ETH', 'Somali', 'F', 4.1),
	(280, 'ETH', 'Tigrinja', 'F', 7.2),
	(281, 'ETH', 'Walaita', 'F', 2.8),
	(282, 'FIN', 'Estonian', 'F', 0.2),
	(283, 'FIN', 'Finnish', 'T', 92.7),
	(284, 'FIN', 'Russian', 'F', 0.4),
	(285, 'FIN', 'Saame', 'F', 0.0),
	(286, 'FIN', 'Swedish', 'T', 5.7),
	(287, 'FJI', 'Fijian', 'T', 50.8),
	(288, 'FJI', 'Hindi', 'F', 43.7),
	(289, 'FLK', 'English', 'T', 0.0),
	(290, 'FRA', 'Arabic', 'F', 2.5),
	(291, 'FRA', 'French', 'T', 93.6),
	(292, 'FRA', 'Italian', 'F', 0.4),
	(293, 'FRA', 'Portuguese', 'F', 1.2),
	(294, 'FRA', 'Spanish', 'F', 0.4),
	(295, 'FRA', 'Turkish', 'F', 0.4),
	(296, 'FRO', 'Danish', 'T', 0.0),
	(297, 'FRO', 'Faroese', 'T', 100.0),
	(298, 'FSM', 'Kosrean', 'F', 7.3),
	(299, 'FSM', 'Mortlock', 'F', 7.6),
	(300, 'FSM', 'Pohnpei', 'F', 23.8),
	(301, 'FSM', 'Trukese', 'F', 41.6),
	(302, 'FSM', 'Wolea', 'F', 3.7),
	(303, 'FSM', 'Yap', 'F', 5.8),
	(304, 'GAB', 'Fang', 'F', 35.8),
	(305, 'GAB', 'Mbete', 'F', 13.8),
	(306, 'GAB', 'Mpongwe', 'F', 14.6),
	(307, 'GAB', 'Punu-sira-nzebi', 'F', 17.1),
	(308, 'GBR', 'English', 'T', 97.3),
	(309, 'GBR', 'Gaeli', 'F', 0.1),
	(310, 'GBR', 'Kymri', 'F', 0.9),
	(311, 'GEO', 'Abhyasi', 'F', 1.7),
	(312, 'GEO', 'Armenian', 'F', 6.8),
	(313, 'GEO', 'Azerbaijani', 'F', 5.5),
	(314, 'GEO', 'Georgiana', 'T', 71.7),
	(315, 'GEO', 'Osseetti', 'F', 2.4),
	(316, 'GEO', 'Russian', 'F', 8.8),
	(317, 'GHA', 'Akan', 'F', 52.4),
	(318, 'GHA', 'Ewe', 'F', 11.9),
	(319, 'GHA', 'Ga-adangme', 'F', 7.8),
	(320, 'GHA', 'Gurma', 'F', 3.3),
	(321, 'GHA', 'Joruba', 'F', 1.3),
	(322, 'GHA', 'Mossi', 'F', 15.8),
	(323, 'GIB', 'Arabic', 'F', 7.4),
	(324, 'GIB', 'English', 'T', 88.9),
	(325, 'GIN', 'Ful', 'F', 38.6),
	(326, 'GIN', 'Kissi', 'F', 6.0),
	(327, 'GIN', 'Kpelle', 'F', 4.6),
	(328, 'GIN', 'Loma', 'F', 2.3),
	(329, 'GIN', 'Malinke', 'F', 23.2),
	(330, 'GIN', 'Susu', 'F', 11.0),
	(331, 'GIN', 'Yalunka', 'F', 2.9),
	(332, 'GLP', 'Creole French', 'F', 95.0),
	(333, 'GLP', 'French', 'T', 0.0),
	(334, 'GMB', 'Diola', 'F', 9.2),
	(335, 'GMB', 'Ful', 'F', 16.2),
	(336, 'GMB', 'Malinke', 'F', 34.1),
	(337, 'GMB', 'Soninke', 'F', 7.6),
	(338, 'GMB', 'Wolof', 'F', 12.6),
	(339, 'GNB', 'Balante', 'F', 14.6),
	(340, 'GNB', 'Crioulo', 'F', 36.4),
	(341, 'GNB', 'Ful', 'F', 16.6),
	(342, 'GNB', 'Malinke', 'F', 6.9),
	(343, 'GNB', 'Mandyako', 'F', 4.9),
	(344, 'GNB', 'Portuguese', 'T', 8.1),
	(345, 'GNQ', 'Bubi', 'F', 8.7),
	(346, 'GNQ', 'Fang', 'F', 84.8),
	(347, 'GRC', 'Greek', 'T', 98.5),
	(348, 'GRC', 'Turkish', 'F', 0.9),
	(349, 'GRD', 'Creole English', 'F', 100.0),
	(350, 'GRL', 'Danish', 'T', 12.5),
	(351, 'GRL', 'Greenlandic', 'T', 87.5),
	(352, 'GTM', 'Cakchiquel', 'F', 8.9),
	(353, 'GTM', 'KekchÃ­', 'F', 4.9),
	(354, 'GTM', 'Mam', 'F', 2.7),
	(355, 'GTM', 'QuichÃ©', 'F', 10.1),
	(356, 'GTM', 'Spanish', 'T', 64.7),
	(357, 'GUF', 'Creole French', 'F', 94.3),
	(358, 'GUF', 'Indian Languages', 'F', 1.9),
	(359, 'GUM', 'Chamorro', 'T', 29.6),
	(360, 'GUM', 'English', 'T', 37.5),
	(361, 'GUM', 'Japanese', 'F', 2.0),
	(362, 'GUM', 'Korean', 'F', 3.3),
	(363, 'GUM', 'Philippene Languages', 'F', 19.7),
	(364, 'GUY', 'Arawakan', 'F', 1.4),
	(365, 'GUY', 'Caribbean', 'F', 2.2),
	(366, 'GUY', 'Creole English', 'F', 96.4),
	(367, 'HKG', 'Canton Chinese', 'F', 88.7),
	(368, 'HKG', 'Chiu chau', 'F', 1.4),
	(369, 'HKG', 'English', 'T', 2.2),
	(370, 'HKG', 'Fukien', 'F', 1.9),
	(371, 'HKG', 'Hakka', 'F', 1.6),
	(372, 'HND', 'Creole English', 'F', 0.2),
	(373, 'HND', 'Garifuna', 'F', 1.3),
	(374, 'HND', 'Miskito', 'F', 0.2),
	(375, 'HND', 'Spanish', 'T', 97.2),
	(376, 'HRV', 'Serbo-Croatian', 'T', 95.9),
	(377, 'HRV', 'Slovene', 'F', 0.0),
	(378, 'HTI', 'French', 'T', 0.0),
	(379, 'HTI', 'Haiti Creole', 'F', 100.0),
	(380, 'HUN', 'German', 'F', 0.4),
	(381, 'HUN', 'Hungarian', 'T', 98.5),
	(382, 'HUN', 'Romani', 'F', 0.5),
	(383, 'HUN', 'Romanian', 'F', 0.1),
	(384, 'HUN', 'Serbo-Croatian', 'F', 0.2),
	(385, 'HUN', 'Slovak', 'F', 0.1),
	(386, 'IDN', 'Bali', 'F', 1.7),
	(387, 'IDN', 'Banja', 'F', 1.8),
	(388, 'IDN', 'Batakki', 'F', 2.2),
	(389, 'IDN', 'Bugi', 'F', 2.2),
	(390, 'IDN', 'Javanese', 'F', 39.4),
	(391, 'IDN', 'Madura', 'F', 4.3),
	(392, 'IDN', 'Malay', 'T', 12.1),
	(393, 'IDN', 'Minangkabau', 'F', 2.4),
	(394, 'IDN', 'Sunda', 'F', 15.8),
	(395, 'IND', 'Asami', 'F', 1.5),
	(396, 'IND', 'Bengali', 'F', 8.2),
	(397, 'IND', 'Gujarati', 'F', 4.8),
	(398, 'IND', 'Hindi', 'T', 39.9),
	(399, 'IND', 'Kannada', 'F', 3.9),
	(400, 'IND', 'Malajalam', 'F', 3.6),
	(401, 'IND', 'Marathi', 'F', 7.4),
	(402, 'IND', 'Orija', 'F', 3.3),
	(403, 'IND', 'Punjabi', 'F', 2.8),
	(404, 'IND', 'Tamil', 'F', 6.3),
	(405, 'IND', 'Telugu', 'F', 7.8),
	(406, 'IND', 'Urdu', 'F', 5.1),
	(407, 'IRL', 'English', 'T', 98.4),
	(408, 'IRL', 'Irish', 'T', 1.6),
	(409, 'IRN', 'Arabic', 'F', 2.2),
	(410, 'IRN', 'Azerbaijani', 'F', 16.8),
	(411, 'IRN', 'Bakhtyari', 'F', 1.7),
	(412, 'IRN', 'Balochi', 'F', 2.3),
	(413, 'IRN', 'Gilaki', 'F', 5.3),
	(414, 'IRN', 'Kurdish', 'F', 9.1),
	(415, 'IRN', 'Luri', 'F', 4.3),
	(416, 'IRN', 'Mazandarani', 'F', 3.6),
	(417, 'IRN', 'Persian', 'T', 45.7),
	(418, 'IRN', 'Turkmenian', 'F', 1.6),
	(419, 'IRQ', 'Arabic', 'T', 77.2),
	(420, 'IRQ', 'Assyrian', 'F', 0.8),
	(421, 'IRQ', 'Azerbaijani', 'F', 1.7),
	(422, 'IRQ', 'Kurdish', 'F', 19.0),
	(423, 'IRQ', 'Persian', 'F', 0.8),
	(424, 'ISL', 'English', 'F', 0.0),
	(425, 'ISL', 'Icelandic', 'T', 95.7),
	(426, 'ISR', 'Arabic', 'T', 18.0),
	(427, 'ISR', 'Hebrew', 'T', 63.1),
	(428, 'ISR', 'Russian', 'F', 8.9),
	(429, 'ITA', 'Albaniana', 'F', 0.2),
	(430, 'ITA', 'French', 'F', 0.5),
	(431, 'ITA', 'Friuli', 'F', 1.2),
	(432, 'ITA', 'German', 'F', 0.5),
	(433, 'ITA', 'Italian', 'T', 94.1),
	(434, 'ITA', 'Romani', 'F', 0.2),
	(435, 'ITA', 'Sardinian', 'F', 2.7),
	(436, 'ITA', 'Slovene', 'F', 0.2),
	(437, 'JAM', 'Creole English', 'F', 94.2),
	(438, 'JAM', 'Hindi', 'F', 1.9),
	(439, 'JOR', 'Arabic', 'T', 97.9),
	(440, 'JOR', 'Armenian', 'F', 1.0),
	(441, 'JOR', 'Circassian', 'F', 1.0),
	(442, 'JPN', 'Ainu', 'F', 0.0),
	(443, 'JPN', 'Chinese', 'F', 0.2),
	(444, 'JPN', 'English', 'F', 0.1),
	(445, 'JPN', 'Japanese', 'T', 99.1),
	(446, 'JPN', 'Korean', 'F', 0.5),
	(447, 'JPN', 'Philippene Languages', 'F', 0.1),
	(448, 'KAZ', 'German', 'F', 3.1),
	(449, 'KAZ', 'Kazakh', 'T', 46.0),
	(450, 'KAZ', 'Russian', 'F', 34.7),
	(451, 'KAZ', 'Tatar', 'F', 2.0),
	(452, 'KAZ', 'Ukrainian', 'F', 5.0),
	(453, 'KAZ', 'Uzbek', 'F', 2.3),
	(454, 'KEN', 'Gusii', 'F', 6.1),
	(455, 'KEN', 'Kalenjin', 'F', 10.8),
	(456, 'KEN', 'Kamba', 'F', 11.2),
	(457, 'KEN', 'Kikuyu', 'F', 20.9),
	(458, 'KEN', 'Luhya', 'F', 13.8),
	(459, 'KEN', 'Luo', 'F', 12.8),
	(460, 'KEN', 'Masai', 'F', 1.6),
	(461, 'KEN', 'Meru', 'F', 5.5),
	(462, 'KEN', 'Nyika', 'F', 4.8),
	(463, 'KEN', 'Turkana', 'F', 1.4),
	(464, 'KGZ', 'Kazakh', 'F', 0.8),
	(465, 'KGZ', 'Kirgiz', 'T', 59.7),
	(466, 'KGZ', 'Russian', 'T', 16.2),
	(467, 'KGZ', 'Tadzhik', 'F', 0.8),
	(468, 'KGZ', 'Tatar', 'F', 1.3),
	(469, 'KGZ', 'Ukrainian', 'F', 1.7),
	(470, 'KGZ', 'Uzbek', 'F', 14.1),
	(471, 'KHM', 'Chinese', 'F', 3.1),
	(472, 'KHM', 'Khmer', 'T', 88.6),
	(473, 'KHM', 'TÅ¡am', 'F', 2.4),
	(474, 'KHM', 'Vietnamese', 'F', 5.5),
	(475, 'KIR', 'Kiribati', 'T', 98.9),
	(476, 'KIR', 'Tuvalu', 'F', 0.5),
	(477, 'KNA', 'Creole English', 'F', 100.0),
	(478, 'KNA', 'English', 'T', 0.0),
	(479, 'KOR', 'Chinese', 'F', 0.1),
	(480, 'KOR', 'Korean', 'T', 99.9),
	(481, 'KWT', 'Arabic', 'T', 78.1),
	(482, 'KWT', 'English', 'F', 0.0),
	(483, 'LAO', 'Lao', 'T', 67.2),
	(484, 'LAO', 'Lao-Soung', 'F', 5.2),
	(485, 'LAO', 'Mon-khmer', 'F', 16.5),
	(486, 'LAO', 'Thai', 'F', 7.8),
	(487, 'LBN', 'Arabic', 'T', 93.0),
	(488, 'LBN', 'Armenian', 'F', 5.9),
	(489, 'LBN', 'French', 'F', 0.0),
	(490, 'LBR', 'Bassa', 'F', 13.7),
	(491, 'LBR', 'Gio', 'F', 7.9),
	(492, 'LBR', 'Grebo', 'F', 8.9),
	(493, 'LBR', 'Kpelle', 'F', 19.5),
	(494, 'LBR', 'Kru', 'F', 7.2),
	(495, 'LBR', 'Loma', 'F', 5.8),
	(496, 'LBR', 'Malinke', 'F', 5.1),
	(497, 'LBR', 'Mano', 'F', 7.2),
	(498, 'LBY', 'Arabic', 'T', 96.0),
	(499, 'LBY', 'Berberi', 'F', 1.0),
	(500, 'LCA', 'Creole French', 'F', 80.0),
	(501, 'LCA', 'English', 'T', 20.0),
	(502, 'LIE', 'German', 'T', 89.0),
	(503, 'LIE', 'Italian', 'F', 2.5),
	(504, 'LIE', 'Turkish', 'F', 2.5),
	(505, 'LKA', 'Mixed Languages', 'F', 19.6),
	(506, 'LKA', 'Singali', 'T', 60.3),
	(507, 'LKA', 'Tamil', 'T', 19.6),
	(508, 'LSO', 'English', 'T', 0.0),
	(509, 'LSO', 'Sotho', 'T', 85.0),
	(510, 'LSO', 'Zulu', 'F', 15.0),
	(511, 'LTU', 'Belorussian', 'F', 1.4),
	(512, 'LTU', 'Lithuanian', 'T', 81.6),
	(513, 'LTU', 'Polish', 'F', 7.0),
	(514, 'LTU', 'Russian', 'F', 8.1),
	(515, 'LTU', 'Ukrainian', 'F', 1.1),
	(516, 'LUX', 'French', 'T', 4.2),
	(517, 'LUX', 'German', 'T', 2.3),
	(518, 'LUX', 'Italian', 'F', 4.6),
	(519, 'LUX', 'Luxembourgish', 'T', 64.4),
	(520, 'LUX', 'Portuguese', 'F', 13.0),
	(521, 'LVA', 'Belorussian', 'F', 4.1),
	(522, 'LVA', 'Latvian', 'T', 55.1),
	(523, 'LVA', 'Lithuanian', 'F', 1.2),
	(524, 'LVA', 'Polish', 'F', 2.1),
	(525, 'LVA', 'Russian', 'F', 32.5),
	(526, 'LVA', 'Ukrainian', 'F', 2.9),
	(527, 'MAC', 'Canton Chinese', 'F', 85.6),
	(528, 'MAC', 'English', 'F', 0.5),
	(529, 'MAC', 'Mandarin Chinese', 'F', 1.2),
	(530, 'MAC', 'Portuguese', 'T', 2.3),
	(531, 'MAR', 'Arabic', 'T', 65.0),
	(532, 'MAR', 'Berberi', 'F', 33.0),
	(533, 'MCO', 'English', 'F', 6.5),
	(534, 'MCO', 'French', 'T', 41.9),
	(535, 'MCO', 'Italian', 'F', 16.1),
	(536, 'MCO', 'Monegasque', 'F', 16.1),
	(537, 'MDA', 'Bulgariana', 'F', 1.6),
	(538, 'MDA', 'Gagauzi', 'F', 3.2),
	(539, 'MDA', 'Romanian', 'T', 61.9),
	(540, 'MDA', 'Russian', 'F', 23.2),
	(541, 'MDA', 'Ukrainian', 'F', 8.6),
	(542, 'MDG', 'French', 'T', 0.0),
	(543, 'MDG', 'Malagasy', 'T', 98.9),
	(544, 'MDV', 'Dhivehi', 'T', 100.0),
	(545, 'MDV', 'English', 'F', 0.0),
	(546, 'MEX', 'Mixtec', 'F', 0.6),
	(547, 'MEX', 'NÃ¡huatl', 'F', 1.8),
	(548, 'MEX', 'OtomÃ­', 'F', 0.4),
	(549, 'MEX', 'Spanish', 'T', 92.1),
	(550, 'MEX', 'Yucatec', 'F', 1.1),
	(551, 'MEX', 'Zapotec', 'F', 0.6),
	(552, 'MHL', 'English', 'T', 0.0),
	(553, 'MHL', 'Marshallese', 'T', 96.8),
	(554, 'MKD', 'Albaniana', 'F', 22.9),
	(555, 'MKD', 'Macedonian', 'T', 66.5),
	(556, 'MKD', 'Romani', 'F', 2.3),
	(557, 'MKD', 'Serbo-Croatian', 'F', 2.0),
	(558, 'MKD', 'Turkish', 'F', 4.0),
	(559, 'MLI', 'Bambara', 'F', 31.8),
	(560, 'MLI', 'Ful', 'F', 13.9),
	(561, 'MLI', 'Senufo and Minianka', 'F', 12.0),
	(562, 'MLI', 'Songhai', 'F', 6.9),
	(563, 'MLI', 'Soninke', 'F', 8.7),
	(564, 'MLI', 'Tamashek', 'F', 7.3),
	(565, 'MLT', 'English', 'T', 2.1),
	(566, 'MLT', 'Maltese', 'T', 95.8),
	(567, 'MMR', 'Burmese', 'T', 69.0),
	(568, 'MMR', 'Chin', 'F', 2.2),
	(569, 'MMR', 'Kachin', 'F', 1.4),
	(570, 'MMR', 'Karen', 'F', 6.2),
	(571, 'MMR', 'Kayah', 'F', 0.4),
	(572, 'MMR', 'Mon', 'F', 2.4),
	(573, 'MMR', 'Rakhine', 'F', 4.5),
	(574, 'MMR', 'Shan', 'F', 8.5),
	(575, 'MNG', 'Bajad', 'F', 1.9),
	(576, 'MNG', 'Buryat', 'F', 1.7),
	(577, 'MNG', 'Dariganga', 'F', 1.4),
	(578, 'MNG', 'Dorbet', 'F', 2.7),
	(579, 'MNG', 'Kazakh', 'F', 5.9),
	(580, 'MNG', 'Mongolian', 'T', 78.8),
	(581, 'MNP', 'Carolinian', 'F', 4.8),
	(582, 'MNP', 'Chamorro', 'F', 30.0),
	(583, 'MNP', 'Chinese', 'F', 7.1),
	(584, 'MNP', 'English', 'T', 4.8),
	(585, 'MNP', 'Korean', 'F', 6.5),
	(586, 'MNP', 'Philippene Languages', 'F', 34.1),
	(587, 'MOZ', 'Chuabo', 'F', 5.7),
	(588, 'MOZ', 'Lomwe', 'F', 7.8),
	(589, 'MOZ', 'Makua', 'F', 27.8),
	(590, 'MOZ', 'Marendje', 'F', 3.5),
	(591, 'MOZ', 'Nyanja', 'F', 3.3),
	(592, 'MOZ', 'Ronga', 'F', 3.7),
	(593, 'MOZ', 'Sena', 'F', 9.4),
	(594, 'MOZ', 'Shona', 'F', 6.5),
	(595, 'MOZ', 'Tsonga', 'F', 12.4),
	(596, 'MOZ', 'Tswa', 'F', 6.0),
	(597, 'MRT', 'Ful', 'F', 1.2),
	(598, 'MRT', 'Hassaniya', 'F', 81.7),
	(599, 'MRT', 'Soninke', 'F', 2.7),
	(600, 'MRT', 'Tukulor', 'F', 5.4),
	(601, 'MRT', 'Wolof', 'F', 6.6),
	(602, 'MRT', 'Zenaga', 'F', 1.2),
	(603, 'MSR', 'English', 'T', 0.0),
	(604, 'MTQ', 'Creole French', 'F', 96.6),
	(605, 'MTQ', 'French', 'T', 0.0),
	(606, 'MUS', 'Bhojpuri', 'F', 21.1),
	(607, 'MUS', 'Creole French', 'F', 70.6),
	(608, 'MUS', 'French', 'F', 3.4),
	(609, 'MUS', 'Hindi', 'F', 1.2),
	(610, 'MUS', 'Marathi', 'F', 0.7),
	(611, 'MUS', 'Tamil', 'F', 0.8),
	(612, 'MWI', 'Chichewa', 'T', 58.3),
	(613, 'MWI', 'Lomwe', 'F', 18.4),
	(614, 'MWI', 'Ngoni', 'F', 6.7),
	(615, 'MWI', 'Yao', 'F', 13.2),
	(616, 'MYS', 'Chinese', 'F', 9.0),
	(617, 'MYS', 'Dusun', 'F', 1.1),
	(618, 'MYS', 'English', 'F', 1.6),
	(619, 'MYS', 'Iban', 'F', 2.8),
	(620, 'MYS', 'Malay', 'T', 58.4),
	(621, 'MYS', 'Tamil', 'F', 3.9),
	(622, 'MYT', 'French', 'T', 20.3),
	(623, 'MYT', 'MahorÃ©', 'F', 41.9),
	(624, 'MYT', 'Malagasy', 'F', 16.1),
	(625, 'NAM', 'Afrikaans', 'F', 9.5),
	(626, 'NAM', 'Caprivi', 'F', 4.7),
	(627, 'NAM', 'German', 'F', 0.9),
	(628, 'NAM', 'Herero', 'F', 8.0),
	(629, 'NAM', 'Kavango', 'F', 9.7),
	(630, 'NAM', 'Nama', 'F', 12.4),
	(631, 'NAM', 'Ovambo', 'F', 50.7),
	(632, 'NAM', 'San', 'F', 1.9),
	(633, 'NCL', 'French', 'T', 34.3),
	(634, 'NCL', 'Malenasian Languages', 'F', 45.4),
	(635, 'NCL', 'Polynesian Languages', 'F', 11.6),
	(636, 'NER', 'Ful', 'F', 9.7),
	(637, 'NER', 'Hausa', 'F', 53.1),
	(638, 'NER', 'Kanuri', 'F', 4.4),
	(639, 'NER', 'Songhai-zerma', 'F', 21.2),
	(640, 'NER', 'Tamashek', 'F', 10.4),
	(641, 'NFK', 'English', 'T', 0.0),
	(642, 'NGA', 'Bura', 'F', 1.6),
	(643, 'NGA', 'Edo', 'F', 3.3),
	(644, 'NGA', 'Ful', 'F', 11.3),
	(645, 'NGA', 'Hausa', 'F', 21.1),
	(646, 'NGA', 'Ibibio', 'F', 5.6),
	(647, 'NGA', 'Ibo', 'F', 18.1),
	(648, 'NGA', 'Ijo', 'F', 1.8),
	(649, 'NGA', 'Joruba', 'F', 21.4),
	(650, 'NGA', 'Kanuri', 'F', 4.1),
	(651, 'NGA', 'Tiv', 'F', 2.3),
	(652, 'NIC', 'Creole English', 'F', 0.5),
	(653, 'NIC', 'Miskito', 'F', 1.6),
	(654, 'NIC', 'Spanish', 'T', 97.6),
	(655, 'NIC', 'Sumo', 'F', 0.2),
	(656, 'NIU', 'English', 'T', 0.0),
	(657, 'NIU', 'Niue', 'F', 0.0),
	(658, 'NLD', 'Arabic', 'F', 0.9),
	(659, 'NLD', 'Dutch', 'T', 95.6),
	(660, 'NLD', 'Fries', 'F', 3.7),
	(661, 'NLD', 'Turkish', 'F', 0.8),
	(662, 'NOR', 'Danish', 'F', 0.4),
	(663, 'NOR', 'English', 'F', 0.5),
	(664, 'NOR', 'Norwegian', 'T', 96.6),
	(665, 'NOR', 'Saame', 'F', 0.0),
	(666, 'NOR', 'Swedish', 'F', 0.3),
	(667, 'NPL', 'Bhojpuri', 'F', 7.5),
	(668, 'NPL', 'Hindi', 'F', 3.0),
	(669, 'NPL', 'Maithili', 'F', 11.9),
	(670, 'NPL', 'Nepali', 'T', 50.4),
	(671, 'NPL', 'Newari', 'F', 3.7),
	(672, 'NPL', 'Tamang', 'F', 4.9),
	(673, 'NPL', 'Tharu', 'F', 5.4),
	(674, 'NRU', 'Chinese', 'F', 8.5),
	(675, 'NRU', 'English', 'T', 7.5),
	(676, 'NRU', 'Kiribati', 'F', 17.9),
	(677, 'NRU', 'Nauru', 'T', 57.5),
	(678, 'NRU', 'Tuvalu', 'F', 8.5),
	(679, 'NZL', 'English', 'T', 87.0),
	(680, 'NZL', 'Maori', 'F', 4.3),
	(681, 'OMN', 'Arabic', 'T', 76.7),
	(682, 'OMN', 'Balochi', 'F', 0.0),
	(683, 'PAK', 'Balochi', 'F', 3.0),
	(684, 'PAK', 'Brahui', 'F', 1.2),
	(685, 'PAK', 'Hindko', 'F', 2.4),
	(686, 'PAK', 'Pashto', 'F', 13.1),
	(687, 'PAK', 'Punjabi', 'F', 48.2),
	(688, 'PAK', 'Saraiki', 'F', 9.8),
	(689, 'PAK', 'Sindhi', 'F', 11.8),
	(690, 'PAK', 'Urdu', 'T', 7.6),
	(691, 'PAN', 'Arabic', 'F', 0.6),
	(692, 'PAN', 'Creole English', 'F', 14.0),
	(693, 'PAN', 'Cuna', 'F', 2.0),
	(694, 'PAN', 'Embera', 'F', 0.6),
	(695, 'PAN', 'GuaymÃ­', 'F', 5.3),
	(696, 'PAN', 'Spanish', 'T', 76.8),
	(697, 'PCN', 'Pitcairnese', 'F', 0.0),
	(698, 'PER', 'AimarÃ¡', 'T', 2.3),
	(699, 'PER', 'KetÅ¡ua', 'T', 16.4),
	(700, 'PER', 'Spanish', 'T', 79.8),
	(701, 'PHL', 'Bicol', 'F', 5.7),
	(702, 'PHL', 'Cebuano', 'F', 23.3),
	(703, 'PHL', 'Hiligaynon', 'F', 9.1),
	(704, 'PHL', 'Ilocano', 'F', 9.3),
	(705, 'PHL', 'Maguindanao', 'F', 1.4),
	(706, 'PHL', 'Maranao', 'F', 1.3),
	(707, 'PHL', 'Pampango', 'F', 3.0),
	(708, 'PHL', 'Pangasinan', 'F', 1.8),
	(709, 'PHL', 'Pilipino', 'T', 29.3),
	(710, 'PHL', 'Waray-waray', 'F', 3.8),
	(711, 'PLW', 'Chinese', 'F', 1.6),
	(712, 'PLW', 'English', 'T', 3.2),
	(713, 'PLW', 'Palau', 'T', 82.2),
	(714, 'PLW', 'Philippene Languages', 'F', 9.2),
	(715, 'PNG', 'Malenasian Languages', 'F', 20.0),
	(716, 'PNG', 'Papuan Languages', 'F', 78.1),
	(717, 'POL', 'Belorussian', 'F', 0.5),
	(718, 'POL', 'German', 'F', 1.3),
	(719, 'POL', 'Polish', 'T', 97.6),
	(720, 'POL', 'Ukrainian', 'F', 0.6),
	(721, 'PRI', 'English', 'F', 47.4),
	(722, 'PRI', 'Spanish', 'T', 51.3),
	(723, 'PRK', 'Chinese', 'F', 0.1),
	(724, 'PRK', 'Korean', 'T', 99.9),
	(725, 'PRT', 'Portuguese', 'T', 99.0),
	(726, 'PRY', 'German', 'F', 0.9),
	(727, 'PRY', 'GuaranÃ­', 'T', 40.1),
	(728, 'PRY', 'Portuguese', 'F', 3.2),
	(729, 'PRY', 'Spanish', 'T', 55.1),
	(730, 'PSE', 'Arabic', 'F', 95.9),
	(731, 'PSE', 'Hebrew', 'F', 4.1),
	(732, 'PYF', 'Chinese', 'F', 2.9),
	(733, 'PYF', 'French', 'T', 40.8),
	(734, 'PYF', 'Tahitian', 'F', 46.4),
	(735, 'QAT', 'Arabic', 'T', 40.7),
	(736, 'QAT', 'Urdu', 'F', 0.0),
	(737, 'REU', 'Chinese', 'F', 2.8),
	(738, 'REU', 'Comorian', 'F', 2.8),
	(739, 'REU', 'Creole French', 'F', 91.5),
	(740, 'REU', 'Malagasy', 'F', 1.4),
	(741, 'REU', 'Tamil', 'F', 0.0),
	(742, 'ROM', 'German', 'F', 0.4),
	(743, 'ROM', 'Hungarian', 'F', 7.2),
	(744, 'ROM', 'Romani', 'T', 0.7),
	(745, 'ROM', 'Romanian', 'T', 90.7),
	(746, 'ROM', 'Serbo-Croatian', 'F', 0.1),
	(747, 'ROM', 'Ukrainian', 'F', 0.3),
	(748, 'RUS', 'Avarian', 'F', 0.4),
	(749, 'RUS', 'Bashkir', 'F', 0.7),
	(750, 'RUS', 'Belorussian', 'F', 0.3),
	(751, 'RUS', 'Chechen', 'F', 0.6),
	(752, 'RUS', 'Chuvash', 'F', 0.9),
	(753, 'RUS', 'Kazakh', 'F', 0.4),
	(754, 'RUS', 'Mari', 'F', 0.4),
	(755, 'RUS', 'Mordva', 'F', 0.5),
	(756, 'RUS', 'Russian', 'T', 86.6),
	(757, 'RUS', 'Tatar', 'F', 3.2),
	(758, 'RUS', 'Udmur', 'F', 0.3),
	(759, 'RUS', 'Ukrainian', 'F', 1.3),
	(760, 'RWA', 'French', 'T', 0.0),
	(761, 'RWA', 'Rwanda', 'T', 100.0),
	(762, 'SAU', 'Arabic', 'T', 95.0),
	(763, 'SDN', 'Arabic', 'T', 49.4),
	(764, 'SDN', 'Bari', 'F', 2.5),
	(765, 'SDN', 'Beja', 'F', 6.4),
	(766, 'SDN', 'Chilluk', 'F', 1.7),
	(767, 'SDN', 'Dinka', 'F', 11.5),
	(768, 'SDN', 'Fur', 'F', 2.1),
	(769, 'SDN', 'Lotuko', 'F', 1.5),
	(770, 'SDN', 'Nubian Languages', 'F', 8.1),
	(771, 'SDN', 'Nuer', 'F', 4.9),
	(772, 'SDN', 'Zande', 'F', 2.7),
	(773, 'SEN', 'Diola', 'F', 5.0),
	(774, 'SEN', 'Ful', 'F', 21.7),
	(775, 'SEN', 'Malinke', 'F', 3.8),
	(776, 'SEN', 'Serer', 'F', 12.5),
	(777, 'SEN', 'Soninke', 'F', 1.3),
	(778, 'SEN', 'Wolof', 'T', 48.1),
	(779, 'SGP', 'Chinese', 'T', 77.1),
	(780, 'SGP', 'Malay', 'T', 14.1),
	(781, 'SGP', 'Tamil', 'T', 7.4),
	(782, 'SHN', 'English', 'T', 0.0),
	(783, 'SJM', 'Norwegian', 'T', 0.0),
	(784, 'SJM', 'Russian', 'F', 0.0),
	(785, 'SLB', 'Malenasian Languages', 'F', 85.6),
	(786, 'SLB', 'Papuan Languages', 'F', 8.6),
	(787, 'SLB', 'Polynesian Languages', 'F', 3.8),
	(788, 'SLE', 'Bullom-sherbro', 'F', 3.8),
	(789, 'SLE', 'Ful', 'F', 3.8),
	(790, 'SLE', 'Kono-vai', 'F', 5.1),
	(791, 'SLE', 'Kuranko', 'F', 3.4),
	(792, 'SLE', 'Limba', 'F', 8.3),
	(793, 'SLE', 'Mende', 'F', 34.8),
	(794, 'SLE', 'Temne', 'F', 31.8),
	(795, 'SLE', 'Yalunka', 'F', 3.4),
	(796, 'SLV', 'Nahua', 'F', 0.0),
	(797, 'SLV', 'Spanish', 'T', 100.0),
	(798, 'SMR', 'Italian', 'T', 100.0),
	(799, 'SOM', 'Arabic', 'T', 0.0),
	(800, 'SOM', 'Somali', 'T', 98.3),
	(801, 'SPM', 'French', 'T', 0.0),
	(802, 'STP', 'Crioulo', 'F', 86.3),
	(803, 'STP', 'French', 'F', 0.7),
	(804, 'SUR', 'Hindi', 'F', 0.0),
	(805, 'SUR', 'Sranantonga', 'F', 81.0),
	(806, 'SVK', 'Czech and Moravian', 'F', 1.1),
	(807, 'SVK', 'Hungarian', 'F', 10.5),
	(808, 'SVK', 'Romani', 'F', 1.7),
	(809, 'SVK', 'Slovak', 'T', 85.6),
	(810, 'SVK', 'Ukrainian and Russian', 'F', 0.6),
	(811, 'SVN', 'Hungarian', 'F', 0.5),
	(812, 'SVN', 'Serbo-Croatian', 'F', 7.9),
	(813, 'SVN', 'Slovene', 'T', 87.9),
	(814, 'SWE', 'Arabic', 'F', 0.8),
	(815, 'SWE', 'Finnish', 'F', 2.4),
	(816, 'SWE', 'Norwegian', 'F', 0.5),
	(817, 'SWE', 'Southern Slavic Languages', 'F', 1.3),
	(818, 'SWE', 'Spanish', 'F', 0.6),
	(819, 'SWE', 'Swedish', 'T', 89.5),
	(820, 'SWZ', 'Swazi', 'T', 89.9),
	(821, 'SWZ', 'Zulu', 'F', 2.0),
	(822, 'SYC', 'English', 'T', 3.8),
	(823, 'SYC', 'French', 'T', 1.3),
	(824, 'SYC', 'Seselwa', 'F', 91.3),
	(825, 'SYR', 'Arabic', 'T', 90.0),
	(826, 'SYR', 'Kurdish', 'F', 9.0),
	(827, 'TCA', 'English', 'T', 0.0),
	(828, 'TCD', 'Arabic', 'T', 12.3),
	(829, 'TCD', 'Gorane', 'F', 6.2),
	(830, 'TCD', 'Hadjarai', 'F', 6.7),
	(831, 'TCD', 'Kanem-bornu', 'F', 9.0),
	(832, 'TCD', 'Mayo-kebbi', 'F', 11.5),
	(833, 'TCD', 'Ouaddai', 'F', 8.7),
	(834, 'TCD', 'Sara', 'F', 27.7),
	(835, 'TCD', 'Tandjile', 'F', 6.5),
	(836, 'TGO', 'Ane', 'F', 5.7),
	(837, 'TGO', 'Ewe', 'T', 23.2),
	(838, 'TGO', 'Gurma', 'F', 3.4),
	(839, 'TGO', 'KabyÃ©', 'T', 13.8),
	(840, 'TGO', 'Kotokoli', 'F', 5.7),
	(841, 'TGO', 'Moba', 'F', 5.4),
	(842, 'TGO', 'Naudemba', 'F', 4.1),
	(843, 'TGO', 'Watyi', 'F', 10.3),
	(844, 'THA', 'Chinese', 'F', 12.1),
	(845, 'THA', 'Khmer', 'F', 1.3),
	(846, 'THA', 'Kuy', 'F', 1.1),
	(847, 'THA', 'Lao', 'F', 26.9),
	(848, 'THA', 'Malay', 'F', 3.6),
	(849, 'THA', 'Thai', 'T', 52.6),
	(850, 'TJK', 'Russian', 'F', 9.7),
	(851, 'TJK', 'Tadzhik', 'T', 62.2),
	(852, 'TJK', 'Uzbek', 'F', 23.2),
	(853, 'TKL', 'English', 'T', 0.0),
	(854, 'TKL', 'Tokelau', 'F', 0.0),
	(855, 'TKM', 'Kazakh', 'F', 2.0),
	(856, 'TKM', 'Russian', 'F', 6.7),
	(857, 'TKM', 'Turkmenian', 'T', 76.7),
	(858, 'TKM', 'Uzbek', 'F', 9.2),
	(859, 'TMP', 'Portuguese', 'T', 0.0),
	(860, 'TMP', 'Sunda', 'F', 0.0),
	(861, 'TON', 'English', 'T', 0.0),
	(862, 'TON', 'Tongan', 'T', 98.3),
	(863, 'TTO', 'Creole English', 'F', 2.9),
	(864, 'TTO', 'English', 'F', 93.5),
	(865, 'TTO', 'Hindi', 'F', 3.4),
	(866, 'TUN', 'Arabic', 'T', 69.9),
	(867, 'TUN', 'Arabic-French', 'F', 26.3),
	(868, 'TUN', 'Arabic-French-English', 'F', 3.2),
	(869, 'TUR', 'Arabic', 'F', 1.4),
	(870, 'TUR', 'Kurdish', 'F', 10.6),
	(871, 'TUR', 'Turkish', 'T', 87.6),
	(872, 'TUV', 'English', 'T', 0.0),
	(873, 'TUV', 'Kiribati', 'F', 7.5),
	(874, 'TUV', 'Tuvalu', 'T', 92.5),
	(875, 'TWN', 'Ami', 'F', 0.6),
	(876, 'TWN', 'Atayal', 'F', 0.4),
	(877, 'TWN', 'Hakka', 'F', 11.0),
	(878, 'TWN', 'Mandarin Chinese', 'T', 20.1),
	(879, 'TWN', 'Min', 'F', 66.7),
	(880, 'TWN', 'Paiwan', 'F', 0.3),
	(881, 'TZA', 'Chaga and Pare', 'F', 4.9),
	(882, 'TZA', 'Gogo', 'F', 3.9),
	(883, 'TZA', 'Ha', 'F', 3.5),
	(884, 'TZA', 'Haya', 'F', 5.9),
	(885, 'TZA', 'Hehet', 'F', 6.9),
	(886, 'TZA', 'Luguru', 'F', 4.9),
	(887, 'TZA', 'Makonde', 'F', 5.9),
	(888, 'TZA', 'Nyakusa', 'F', 5.4),
	(889, 'TZA', 'Nyamwesi', 'F', 21.1),
	(890, 'TZA', 'Shambala', 'F', 4.3),
	(891, 'TZA', 'Swahili', 'T', 8.8),
	(892, 'UGA', 'Acholi', 'F', 4.4),
	(893, 'UGA', 'Ganda', 'F', 18.1),
	(894, 'UGA', 'Gisu', 'F', 4.5),
	(895, 'UGA', 'Kiga', 'F', 8.3),
	(896, 'UGA', 'Lango', 'F', 5.9),
	(897, 'UGA', 'Lugbara', 'F', 4.7),
	(898, 'UGA', 'Nkole', 'F', 10.7),
	(899, 'UGA', 'Rwanda', 'F', 3.2),
	(900, 'UGA', 'Soga', 'F', 8.2),
	(901, 'UGA', 'Teso', 'F', 6.0),
	(902, 'UKR', 'Belorussian', 'F', 0.3),
	(903, 'UKR', 'Bulgariana', 'F', 0.3),
	(904, 'UKR', 'Hungarian', 'F', 0.3),
	(905, 'UKR', 'Polish', 'F', 0.1),
	(906, 'UKR', 'Romanian', 'F', 0.7),
	(907, 'UKR', 'Russian', 'F', 32.9),
	(908, 'UKR', 'Ukrainian', 'T', 64.7),
	(909, 'UMI', 'English', 'T', 0.0),
	(910, 'URY', 'Spanish', 'T', 95.7),
	(911, 'USA', 'Chinese', 'F', 0.6),
	(912, 'USA', 'English', 'T', 86.2),
	(913, 'USA', 'French', 'F', 0.7),
	(914, 'USA', 'German', 'F', 0.7),
	(915, 'USA', 'Italian', 'F', 0.6),
	(916, 'USA', 'Japanese', 'F', 0.2),
	(917, 'USA', 'Korean', 'F', 0.3),
	(918, 'USA', 'Polish', 'F', 0.3),
	(919, 'USA', 'Portuguese', 'F', 0.2),
	(920, 'USA', 'Spanish', 'F', 7.5),
	(921, 'USA', 'Tagalog', 'F', 0.4),
	(922, 'USA', 'Vietnamese', 'F', 0.2),
	(923, 'UZB', 'Karakalpak', 'F', 2.0),
	(924, 'UZB', 'Kazakh', 'F', 3.8),
	(925, 'UZB', 'Russian', 'F', 10.9),
	(926, 'UZB', 'Tadzhik', 'F', 4.4),
	(927, 'UZB', 'Tatar', 'F', 1.8),
	(928, 'UZB', 'Uzbek', 'T', 72.6),
	(929, 'VAT', 'Italian', 'T', 0.0),
	(930, 'VCT', 'Creole English', 'F', 99.1),
	(931, 'VCT', 'English', 'T', 0.0),
	(932, 'VEN', 'Goajiro', 'F', 0.4),
	(933, 'VEN', 'Spanish', 'T', 96.9),
	(934, 'VEN', 'Warrau', 'F', 0.1),
	(935, 'VGB', 'English', 'T', 0.0),
	(936, 'VIR', 'English', 'T', 81.7),
	(937, 'VIR', 'French', 'F', 2.5),
	(938, 'VIR', 'Spanish', 'F', 13.3),
	(939, 'VNM', 'Chinese', 'F', 1.4),
	(940, 'VNM', 'Khmer', 'F', 1.4),
	(941, 'VNM', 'Man', 'F', 0.7),
	(942, 'VNM', 'Miao', 'F', 0.9),
	(943, 'VNM', 'Muong', 'F', 1.5),
	...
	(945, 'VNM', 'Thai', 'F', 1.6),
	(946, 'VNM', 'Tho', 'F', 1.8),
	(947, 'VNM', 'Vietnamese', 'T', 86.8),
	(948, 'VUT', 'Bislama', 'T', 56.6),
	(949, 'VUT', 'English', 'T', 28.3),
	(950, 'VUT', 'French', 'T', 14.2),
	(951, 'WLF', 'Futuna', 'F', 0.0),
	(952, 'WLF', 'Wallis', 'F', 0.0),
	(953, 'WSM', 'English', 'T', 0.6),
	(954, 'WSM', 'Samoan', 'T', 47.5),
	(955, 'WSM', 'Samoan-English', 'F', 52.0),
	(956, 'YEM', 'Arabic', 'T', 99.6),
	(957, 'YEM', 'Soqutri', 'F', 0.0),
	(958, 'YUG', 'Albaniana', 'F', 16.5),
	(959, 'YUG', 'Hungarian', 'F', 3.4),
	(960, 'YUG', 'Macedonian', 'F', 0.5),
	(961, 'YUG', 'Romani', 'F', 1.4),
	(962, 'YUG', 'Serbo-Croatian', 'T', 75.2),
	(963, 'YUG', 'Slovak', 'F', 0.7),
	(964, 'ZAF', 'Afrikaans', 'T', 14.3),
	(965, 'ZAF', 'English', 'T', 8.5),
	(966, 'ZAF', 'Ndebele', 'F', 1.5),
	(967, 'ZAF', 'Northsotho', 'F', 9.1),
	(968, 'ZAF', 'Southsotho', 'F', 7.6),
	(969, 'ZAF', 'Swazi', 'F', 2.5),
	(970, 'ZAF', 'Tsonga', 'F', 4.3),
	(971, 'ZAF', 'Tswana', 'F', 8.1),
	(972, 'ZAF', 'Venda', 'F', 2.2),
	(973, 'ZAF', 'Xhosa', 'T', 17.7),
	(974, 'ZAF', 'Zulu', 'T', 22.7),
	(975, 'ZMB', 'Bemba', 'F', 29.7),
	(976, 'ZMB', 'Chewa', 'F', 5.7),
	(977, 'ZMB', 'Lozi', 'F', 6.4),
	(978, 'ZMB', 'Nsenga', 'F', 4.3),
	(979, 'ZMB', 'Nyanja', 'F', 7.8),
	(980, 'ZMB', 'Tongan', 'F', 11.0),
	(981, 'ZWE', 'English', 'T', 2.2),
	(982, 'ZWE', 'Ndebele', 'F', 16.2),
	(983, 'ZWE', 'Nyanja', 'F', 2.2),
	(984, 'ZWE', 'Shona', 'F', 72.1);
/*!40000 ALTER TABLE `countrylanguage` ENABLE KEYS */;

-- Dumping structure for table world.django_admin_log
...
CREATE TABLE IF NOT EXISTS `django_admin_log` (
  ...
  KEY `django_admin_log_user_id_c564eba6_fk_world_user_email` (`user_id`),
  CONSTRAINT `django_admin_log_content_type_id_c4bce8eb_fk_django_co` FOREIGN KEY (`content_type_id`) REFERENCES `django_content_type` (`id`),
  CONSTRAINT `django_admin_log_user_id_c564eba6_fk_world_user_email` FOREIGN KEY (`user_id`) REFERENCES `world_user` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table world.django_admin_log: ~0 rows (approximately)
/*!40000 ALTER TABLE `django_admin_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `django_admin_log` ENABLE KEYS */;

-- Dumping structure for table world.django_content_type
...
-- Dumping data for table world.django_content_type: ~10 rows (approximately)
...
INSERT IGNORE INTO `django_content_type` (`id`, `app_label`, `model`) VALUES
	...
	(6, 'world', 'city'),
	(7, 'world', 'country'),
	(9, 'world', 'countrylanguage'),
	(8, 'world', 'djangomigrations'),
	(10, 'world', 'user');
/*!40000 ALTER TABLE `django_content_type` ENABLE KEYS */;

-- Dumping structure for table world.django_migrations
...
-- Dumping data for table world.django_migrations: ~19 rows (approximately)
/*!40000 ALTER TABLE `django_migrations` DISABLE KEYS */;
INSERT IGNORE INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES
	(1, 'contenttypes', '0001_initial', '2024-10-04 19:07:13.360066'),
	(2, 'contenttypes', '0002_remove_content_type_name', '2024-10-04 19:07:13.556295'),
	(3, 'auth', '0001_initial', '2024-10-04 19:07:14.384838'),
	(4, 'auth', '0002_alter_permission_name_max_length', '2024-10-04 19:07:14.551028'),
	(5, 'auth', '0003_alter_user_email_max_length', '2024-10-04 19:07:14.566024'),
	(6, 'auth', '0004_alter_user_username_opts', '2024-10-04 19:07:14.578985'),
	(7, 'auth', '0005_alter_user_last_login_null', '2024-10-04 19:07:14.593412'),
	(8, 'auth', '0006_require_contenttypes_0002', '2024-10-04 19:07:14.598506'),
	(9, 'auth', '0007_alter_validators_add_error_messages', '2024-10-04 19:07:14.612787'),
	(10, 'auth', '0008_alter_user_username_max_length', '2024-10-04 19:07:14.621788'),
	(11, 'auth', '0009_alter_user_last_name_max_length', '2024-10-04 19:07:14.634793'),
	(12, 'auth', '0010_alter_group_name_max_length', '2024-10-04 19:07:14.684686'),
	(13, 'auth', '0011_update_proxy_permissions', '2024-10-04 19:07:14.698735'),
	(14, 'auth', '0012_alter_user_first_name_max_length', '2024-10-04 19:07:14.709785'),
	(15, 'world', '0001_initial', '2024-10-04 19:07:15.583120'),
	(16, 'admin', '0001_initial', '2024-10-04 19:07:16.022051'),
	(17, 'admin', '0002_logentry_remove_auto_add', '2024-10-04 19:07:16.036760'),
	(18, 'admin', '0003_logentry_add_action_flag_choices', '2024-10-04 19:07:16.048215'),
	(19, 'sessions', '0001_initial', '2024-10-04 19:07:16.148385');
/*!40000 ALTER TABLE `django_migrations` ENABLE KEYS */;

-- Dumping structure for table world.django_session
...
-- Dumping data for table world.django_session: ~1 rows (approximately)
/*!40000 ALTER TABLE `django_session` DISABLE KEYS */;
INSERT IGNORE INTO `django_session` (`session_key`, `session_data`, `expire_date`) VALUES
	('8btcusfrh70rfaoyupcc23rcpkikh8nx', 'eyJhdXRoX290cCI6IjNWV1dWRiIsImF1dGhfZW1haWwiOiIifQ:1sxh7t:3qkRlBGzlkQ9gdYKC61sJWUxzIUPSlgegkEvG0tK1sI', '2024-10-21 06:21:49.377404');
/*!40000 ALTER TABLE `django_session` ENABLE KEYS */;

-- Dumping structure for table world.world_user
...
-- Dumping data for table world.world_user: ~0 rows (approximately)
/*!40000 ALTER TABLE `world_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `world_user` ENABLE KEYS */;

-- Dumping structure for table world.world_user_groups
DROP TABLE IF EXISTS `world_user_groups`;
CREATE TABLE IF NOT EXISTS `world_user_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(100) NOT NULL,
  `group_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `world_user_groups_user_id_group_id_0f06a59d_uniq` (`user_id`,`group_id`),
  KEY `world_user_groups_group_id_3cc8bb01_fk_auth_group_id` (`group_id`),
  CONSTRAINT `world_user_groups_group_id_3cc8bb01_fk_auth_group_id` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`),
  CONSTRAINT `world_user_groups_user_id_8d4da002_fk_world_user_email` FOREIGN KEY (`user_id`) REFERENCES `world_user` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table world.world_user_groups: ~0 rows (approximately)
/*!40000 ALTER TABLE `world_user_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `world_user_groups` ENABLE KEYS */;

-- Dumping structure for table world.world_user_user_permissions
DROP TABLE IF EXISTS `world_user_user_permissions`;
CREATE TABLE IF NOT EXISTS `world_user_user_permissions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(100) NOT NULL,
  `permission_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `world_user_user_permissions_user_id_permission_id_45bdd490_uniq` (`user_id`,`permission_id`),
  KEY `world_user_user_perm_permission_id_4106cd2c_fk_auth_perm` (`permission_id`),
  CONSTRAINT `world_user_user_perm_permission_id_4106cd2c_fk_auth_perm` FOREIGN KEY (`permission_id`) REFERENCES `auth_permission` (`id`),
  CONSTRAINT `world_user_user_permissions_user_id_75b4194d_fk_world_user_email` FOREIGN KEY (`user_id`) REFERENCES `world_user` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table world.world_user_user_permissions: ~0 rows (approximately)
/*!40000 ALTER TABLE `world_user_user_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `world_user_user_permissions` ENABLE KEYS */;
